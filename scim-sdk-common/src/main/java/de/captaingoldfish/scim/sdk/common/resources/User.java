...
public class User extends ResourceNode {
    ...
    /**
     * The defined business unit of the employee
     */
    public Optional<String> getBusinessUnit() {
        return getStringAttribute(AttributeNames.BEEX.BUSINESS_UNIT);
    }
    ...
    public void setBusinessUnit(String businessUnit) {
        setAttribute(AttributeNames.BEEX.BUSINESS_UNIT, businessUnit);
    }
}
